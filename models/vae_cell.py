...
class VAECell(object):
    def __init__(self, state_is_tuple=True):
        ...
        self.bow_fc2 = nn.Linear(params.state_cell_size + 200, 400)
    ...
    def decode(self, z_samples, h_prev, dec_input_embedding, forward=False):
        ...
        dec_input_1 = torch.cat([h_prev, net2],
        ...
        if params.with_BOW:
            ...
            bow_logits1 = self.bow_project1(bow_fc1)
            print("self.bow_logits[1]")  #(batch_size, vocab_size)
            print(self.bow_logits1)

            bow_fc2 = self.bow_fc2(dec_input_2_h)
            bow_fc2 = F.tanh(bow_fc2)
            if params.dropout > 0:
